...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  app.get(
    routes.inboxes + '/:inbox', ensureAuthenticated, brRest.when.prefers.ld,
    (req, res, next) => {
  ...
  // get a message
  app.get(
    routes.messages + '/:message', ensureAuthenticated, brRest.when.prefers.ld,
    (req, res, next) => {
